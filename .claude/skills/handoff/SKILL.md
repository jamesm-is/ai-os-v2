...
- `.claude/skills/improve-codebase-architecture/` → copy the full directory (SKILL.md, LANGUAGE.md, DEEPENING.md, HTML-REPORT.md, INTERFACE-DESIGN.md) into both `.claude/skills/improve-codebase-architecture/` and `.agents/skills/improve-codebase-architecture/`.

**Utility skills** — copy verbatim from ai-os-v2 (already path-neutral):

- `.claude/skills/relay/SKILL.md` → both `.claude/skills/relay/SKILL.md` and `.agents/skills/relay/SKILL.md`
- `.claude/skills/relay-handoff/SKILL.md` → both `.claude/skills/relay-handoff/SKILL.md` and `.agents/skills/relay-handoff/SKILL.md`
