    ...
    const inner = Effect.gen(function* () {
        ...
        const handle = yield* Effect.gen(function* () {
            ...
            if (sandboxProvider.tag === "none") {
                ...
                return yield* Effect.promise(() => sandboxProvider.create({
                    worktreePath,
                    env: effectiveEnv,
                }));
            }
        ...
        }).pipe(Effect.tapError(() => worktreeInfo
