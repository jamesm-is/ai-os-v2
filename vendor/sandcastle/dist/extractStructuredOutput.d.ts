 ...
 */
export declare const extractStructuredOutput: <T>(stdout: string, definition: OutputDefinition, context: ExtractionContext) => Promise<T>;
export {};
//# sourceMappingURL=extractStructuredOutput.d.ts.map